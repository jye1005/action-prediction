...
def main():
    ...
    print(f"search_train={len(train_texts)} search_val={len(val_texts)} fold={args.fold}/{args.n_splits}")
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if macro_f1 > best_f1:
                ...
                json.dump(
                    {
                        ...
                        "best_val_search_macro_f1": best_f1,
                        "fold": args.fold,
            ...
            print(f"saved best search specialist to {args.output_dir}")
